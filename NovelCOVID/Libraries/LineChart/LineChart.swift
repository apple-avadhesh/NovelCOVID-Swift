...
class LineChart: UIView {
    ...
    private func setupView() {
        ...
        gradientLayer.colors = [#colorLiteral(red: 0.03921568627, green: 0.5176470588, blue: 1, alpha: 1).cgColor, UIColor.clear.cgColor]
    ...
    private func drawLables() {
        if let dataEntries = dataEntries,
            ...
            for i in 0..<dataEntries.count {
                ...
                textLayer.frame = CGRect(x: lineGap*CGFloat(i) - lineGap/2 + 40, y: mainLayer.frame.size.height - bottomSpace/2, width: lineGap, height: 16)
    ...
    private func drawHorizontalLines() {
        ...
        if let gridValues = gridValues {
            for value in gridValues {
                ...
                textLayer.string = "\(lineValue.shorted())"
